...
namespace MaxFactry.General.AspNet.IIS.Mvc4
{
    ...
    /// </summary>
    public class MaxAppLibrary : MaxFactry.General.AspNet.IIS.MaxAppLibrary
    {
        /// <summary>
        ...
        public new static IMaxAppLibraryProvider Provider
        {
            get
            {
                return MaxFactry.General.AspNet.IIS.MaxAppLibrary.Provider as IMaxAppLibraryProvider;
            }
        }
   }
}