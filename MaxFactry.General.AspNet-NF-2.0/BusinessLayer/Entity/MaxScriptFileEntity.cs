// <copyright file="MaxScriptFileEntity.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.General.AspNet.BusinessLayer
{
    ...
    /// </summary>
    public class MaxScriptFileEntity : MaxBaseIdVersionedEntity
    {
        /// <summary>
        /// Initializes a new instance of the MaxScriptFileEntity class
        /// </summary>
        /// <param name="loData">object to hold data</param>
        public MaxScriptFileEntity(MaxData loData)
            : base(loData)
        {
        }
        ...
        public MaxScriptFileEntity(Type loDataModelType)
        ...
        public string ScriptType
        {
            get
            {
                return this.GetString(this.DataModel.ScriptType);
            }

            set
            {
                this.Set(this.DataModel.ScriptType, value);
            }
        }
        ...
        /// </summary>
        protected MaxScriptFileDataModel DataModel
        {
            get
            {
                return (MaxScriptFileDataModel)MaxDataLibrary.GetDataModel(this.DataModelType);
            }
        }

        /// <summary>
        /// Creates a new instance of the MaxScriptFileEntity class.
        /// </summary>
        /// <returns>a new instance of the MaxScriptFileEntity class.</returns>
        public static MaxScriptFileEntity Create()
        {
            return MaxBusinessLibrary.GetEntity(
                typeof(MaxScriptFileEntity),
                typeof(MaxScriptFileDataModel)) as MaxScriptFileEntity;
        }
