// <copyright file="IMaxVirtualTextFileRepositoryProvider.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.General.AspNet.DataLayer
{
    ...
    /// </summary>
    public interface IMaxBaseAspNetRepositoryProvider : IMaxBaseIdRepositoryProvider
    {
    }
}
