// <copyright file="MaxStyleFileDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.General.AspNet.DataLayer
{
	...
	/// </summary>
	public class MaxStyleFileDataModel : MaxBaseIdVersionedDataModel
	{
		/// <summary>
        ...
        /// </summary>
        public readonly string StyleType = "StyleType";

		/// <summary>
        /// Initializes a new instance of the MaxStyleFileDataModel class.
		/// </summary>
        public MaxStyleFileDataModel()
            : base()
		{
