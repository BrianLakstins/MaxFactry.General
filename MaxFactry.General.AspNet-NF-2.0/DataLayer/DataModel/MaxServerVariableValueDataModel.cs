...
namespace MaxFactry.General.AspNet.DataLayer
{
	...
	public class MaxServerVariableValueDataModel : MaxBaseGuidKeyDataModel
	{
		...
		/// </summary>
        public readonly string ServerVariableId = "ServerVariableId";
		...
		/// </summary>
        public MaxServerVariableValueDataModel()
            : base()
		{
            ...
            this.SetDataStorageName("MaxCoreAspNetServerVariableValue");
            this.AddType(this.ServerVariableId, typeof(Guid));
