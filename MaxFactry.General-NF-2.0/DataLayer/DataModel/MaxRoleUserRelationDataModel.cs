// <copyright file="MaxRoleUserRelationDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.General.DataLayer
{
	...
	/// </summary>
    public class MaxRoleUserRelationDataModel : MaxRelationDataModel
	{
		/// <summary>
		...
		/// </summary>
        public MaxRoleUserRelationDataModel()
            : base()
		{
            this.SetDataStorageName("MaxSecurityRoleUserRelation");
            this.AddType(this.RoleName, typeof(string));
            this.RepositoryProviderType = typeof(MaxFactry.General.DataLayer.Provider.MaxSecurityRepositoryDefaultProvider);
            this.RepositoryType = typeof(MaxRoleUserRelationRepository);
		}
	}
}
