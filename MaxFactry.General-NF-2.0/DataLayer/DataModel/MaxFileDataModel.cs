// <copyright file="MaxFileDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.General.DataLayer
{
	...
	/// </summary>
	public class MaxFileDataModel : MaxBaseIdFileDataModel
	{
		/// <summary>
		/// The Id of something this file is related to.
		/// </summary>
            ...
            : base()
		{
            ...
            this.SetDataStorageName("MaxFile");
            this.AddNullable(this.RelatedId, typeof(Guid));
        }
	}
}
