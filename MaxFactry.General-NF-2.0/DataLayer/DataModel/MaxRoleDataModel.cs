// <copyright file="MaxRoleDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.General.DataLayer
{
	...
	/// </summary>
    public class MaxRoleDataModel : MaxBaseGuidKeyDataModel
    {
		/// <summary>
		/// Name of role.
		/// </summary>
		...
		/// <summary>
        /// Initializes a new instance of the MaxRoleDataModel class.
		/// </summary>
        public MaxRoleDataModel()
            : base()
		{
            this.SetDataStorageName("MaxSecurityRole");
