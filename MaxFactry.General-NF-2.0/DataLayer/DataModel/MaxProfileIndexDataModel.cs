// <copyright file="MaxProfileIndexDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.General.DataLayer
{
	...
	/// </summary>
	public class MaxProfileIndexDataModel : MaxBaseIdIndexDataModel
	{
		/// <summary>
        /// Initializes a new instance of the MaxProfileIndexDataModel class.
		/// </summary>
