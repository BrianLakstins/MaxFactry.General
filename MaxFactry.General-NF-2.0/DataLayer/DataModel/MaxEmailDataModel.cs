// <copyright file="MaxEmailDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.General.DataLayer
{
	...
	/// </summary>
	public class MaxEmailDataModel : MaxBaseEmailDataModel
	{
        /// <summary>
        /// Initializes a new instance of the MaxFormDataModel class.
		/// </summary>
        public MaxEmailDataModel()
            : base()
		{
            ...
            this.SetDataStorageName("MaxCoreEmail");
        }

        public MaxEmailDataModel(string lsDataStorageName) : this()
        {
