// <copyright file="MaxUserIndexDataModel.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.General.DataLayer
{
	...
	/// </summary>
	public class MaxUserIndexDataModel : MaxBaseIdIndexDataModel
	{
		/// <summary>
        /// Initializes a new instance of the MaxUserIndexDataModel class.
		/// </summary>
