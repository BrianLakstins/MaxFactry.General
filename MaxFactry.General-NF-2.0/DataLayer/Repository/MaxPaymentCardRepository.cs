// <copyright file="MaxPaymentCardRepository.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.General.DataLayer
{
    ...
    /// <summary>
    /// Repository for accessing Payment Card information.
    /// </summary>
    public class MaxPaymentCardRepository : MaxBaseReadRepository
    {
    }
}
