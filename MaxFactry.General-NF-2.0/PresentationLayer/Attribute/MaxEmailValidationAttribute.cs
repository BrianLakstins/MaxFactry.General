// <copyright file="MaxEmailValidationAttribute.cs" company="Lakstins Family, LLC">
...
namespace MaxFactry.General.PresentationLayer
{
    ...
    /// </summary>
    public class MaxEmailValidationAttribute : ValidationAttribute
    {
        /// <summary>
        /// Initializes a new instance of the MaxCreditCartValidationAttribute class.
        /// </summary>
        public MaxEmailValidationAttribute()
            : base()
        {
        }
        ...
        protected override ValidationResult IsValid(object value, ValidationContext loContext)
        {
            if (null != value)
            {
                ...
                {
                    return new ValidationResult("Email address format is not valid.");
                }
            }

            return new ValidationResult("Email address was not supplied.");
        }
    }
}